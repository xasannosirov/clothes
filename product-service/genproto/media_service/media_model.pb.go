...
type Media struct {
	...
	FilenName            string   `protobuf:"bytes,4,opt,name=filen_name,json=filenName,proto3" json:"filen_name,omitempty"`
...
func (m *Media) GetFilenName() string {
	if m != nil {
		return m.FilenName
	}
	return ""
...
var fileDescriptor_af9ec23b75e9f146 = []byte{
	...
	,
}
...
func (m *Media) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FilenName) > 0 {
		i -= len(m.FilenName)
		copy(dAtA[i:], m.FilenName)
		i = encodeVarintMediaModel(dAtA, i, uint64(len(m.FilenName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ImageUrl) > 0 {
...
func (m *Media) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilenName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FilenName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
