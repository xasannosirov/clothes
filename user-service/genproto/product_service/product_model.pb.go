...
type Product struct {
	...
	Size_                []string `protobuf:"bytes,13,rep,name=size,proto3" json:"size,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Product) GetSize_() []string {
	if m != nil {
		return m.Size_
	}
	return nil
...
var fileDescriptor_489eb156fdcd4f1c = []byte{
	...
	,
}
...
func (m *Product) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Size_) > 0 {
		for iNdEx := len(m.Size_) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProductModel(dAtA, i, uint64(len(m.Size_[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
