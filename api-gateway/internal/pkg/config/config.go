...
func NewConfig() (*Config, error) {
	...
	config.Server.Host = getEnv("SERVER_HOST", "localhost") // api
	...
	//user service
	config.UserService.Host = getEnv("USER_SERVICE_GRPC_HOST", "localhost") // user-service
	config.UserService.Port = getEnv("USER_SERVICE_GRPC_PORT", ":1111")

	//media service
	config.MediaService.Host = getEnv("MEDIA_SERVICE_GRPC_HOST", "localhost") //media-service
	config.MediaService.Port = getEnv("MEDIA_SERVICE_GRPC_PORT", ":2222")

	//product service
	config.ProductService.Host = getEnv("PRODUCT_SERVICE_GRPC_HOST", "localhost") // product-service
